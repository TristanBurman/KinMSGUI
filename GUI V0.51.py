...
##############################################################################
        ...
        SBSubFrame.grid(row=5, columnspan=4)
        TK.Button(SBSubFrame, text='Gaussian', width=10, command=lambda : self.SBExamples(Type='Gaussian')).grid(row=2, column=0, columnspan=2, sticky="e")
        TK.Button(SBSubFrame, text='Exponential', width=10, command=lambda : self.SBExamples(Type='Exponential')).grid(row=2, column=2, columnspan=2, sticky="w")
...
#        self.FileInput.set(TK.Label(self.master, text=self.FileInput, bg='black', fg='white', font='none 12 bold').grid(row=0, column=1, sticky="w") )
        ...
        xBoundry, yBoundry = np.array([np.min(xAOI)-4, np.max(xAOI)+4]), np.array([np.min(yAOI)-4, np.max(yAOI)+4])
